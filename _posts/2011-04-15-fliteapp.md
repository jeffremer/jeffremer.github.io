...
Our web-based studios are very nice for what they are, but they certainly will never improve to the point where someone who develops components like me will find them more useful than using a text editor.  They will always be a bottleneck and the primary entry points we have for using our product is not a good place to annoy users.
