...
Our tools are not nimble enough.  I say this primarily as a developer, I'm definitely not the typical user. Having to workaround our own tools is clearly not the right process and I see examples of this more and more.
...
The various studios do not fit the way I think as a programmer.  They were designed around the core Widgetbox models, which made sense when all you made was a Widget and you got an instance of it, then just pasted that and forgot about it.
...
This idea mostly stems from my frustrations in using our own tools to create
Flite products.  Obviously I am a atypical power user.  However I still think
my perspective is relevant for every user.  All users want efficient, effective
nimble tools.	